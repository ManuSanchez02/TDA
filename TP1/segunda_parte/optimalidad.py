...
def comparar_algoritmos(mercaderias, soluciones, sobornos):
    ...
    for i in range(len(mercaderias)):
        ...
        error_actual_dinamico = calcular_error(sobornar_dinamico, mercaderia, solucion, soborno)
        error_total_dinamica += error_actual_dinamico
        ...
        print(f"Error de dinamica: {error_actual_dinamico}%")
        print(f"Error de greedy (por minimos): {error_actual_greedy_min}%")

    print("-----Fin de simulacion-----")
    print(f"Error de greedy (promedio): {error_actual_greedy / len(mercaderias)}%")
    print(f"Error de dinamico (promedio): {error_actual_dinamico / len(mercaderias)}%")
    print(f"Error de greedy por minimos (promedio): {error_actual_greedy_min / len(mercaderias)}%")
